//! Core Guidance Rules for Nova Agent
//!
//! Basic rules: Git, Tasks, DeepWork, CommitHygiene, ActivityPattern

use crate::guidance_types::{
    GuidanceAction, GuidanceCategory, GuidanceInput, GuidanceItem, GuidancePriority,
    GuidanceRule, timestamp_now,
};
...
pub struct ActivityPatternRule;
