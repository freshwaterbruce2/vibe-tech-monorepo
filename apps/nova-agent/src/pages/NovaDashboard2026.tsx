...
import { formatRelativeTime, useActivityLogger, useNovaData } from '@/hooks/useNovaData';
    ...
    return (
      <div className="flex items-center justify-center py-20">
        ...
        >
          ...
          <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '1.125rem', fontWeight: 500 }}>
            Initializing NOVA...
          </span>
        </motion.div>
      </div>
        ...
        >
          <div
            style={{
              ...
              borderRadius: '16px',
              background:
                'linear-gradient(135deg, rgba(239, 68, 68, 0.2), rgba(236, 72, 153, 0.1))',
              border: '1px solid rgba(239, 68, 68, 0.2)',
              display: 'flex',
              alignItems: 'center',
        ...
        <motion.div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <MetricCard2026
              label="Deep Work"
              value={
                context?.deep_work_minutes ? `${Math.floor(context.deep_work_minutes)}m` : '0m'
              }
              icon={Clock}
              color="cyan"
            />
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p style={{ color: 'rgba(255,255,255,0.5)' }}>
                    Ask NOVA anything or get help with your projects
                  </p>
                </div>
              </div>
              <motion.button
                ...
                whileHover={{
                  scale: 1.05,
                  boxShadow: '0 8px 30px rgba(176, 38, 255, 0.6), 0 0 60px rgba(255, 45, 149, 0.4)',
                }}
                whileTap={{ scale: 0.95 }}
              >
        ...
        <motion.div>
          ...
          >
            ...
            >
              ...
              <span
                style={{ fontSize: '0.875rem', fontWeight: 500, color: 'rgba(255,255,255,0.8)' }}
              >
                Refresh
              </span>
            </motion.button>
