...
const PalettePreview = () => {
	const tokenColors: ColorSwatch[] = [
		...
		},
		{
			...
			value: "var(--glass-bg)",
			cssVarName: "--glass-bg",
			tailwindClass: "bg-futuristic-glassOverlay",
		},
		{
			name: "Background Start",
			value: "var(--bg-start)",
			cssVarName: "--bg-start",
			tailwindClass: "bg-futuristic-darkBg",
		},
	];
	...
	const auraColors: ColorSwatch[] = [
		{
			name: "Aura Neon Blue",
			value: "var(--c-cyan)",
			tailwindClass: "bg-aura-neonBlue",
		},
		{
			name: "Aura Neon Purple",
			value: "var(--c-purple)",
			tailwindClass: "bg-aura-neonPurple",
		},
		{
			name: "Aura Neon Cyan",
			value: "var(--c-cyan)",
			tailwindClass: "bg-aura-neonCyan",
		},
		{
			name: "Aura Dark Background",
			value: "var(--bg-start)",
			tailwindClass: "bg-aura-darkBg",
		},
	];

	const futuristicColors: ColorSwatch[] = [
		{
			name: "Futuristic Neon Blue",
			value: "var(--c-cyan)",
			tailwindClass: "bg-futuristic-neonBlue",
		},
		{
			name: "Futuristic Neon Purple",
			value: "var(--c-purple)",
			tailwindClass: "bg-futuristic-neonPurple",
		},
		{
			name: "Futuristic Dark Background",
			value: "var(--bg-start)",
			tailwindClass: "bg-futuristic-darkBg",
		},
		{
			name: "Futuristic Glass Overlay",
			value: "var(--glass-bg)",
			tailwindClass: "bg-futuristic-glassOverlay",
		},
	];
	...
	const renderColorCard = (color: ColorSwatch) => (
		<Card key={color.name} className="glass-card p-6">
			...
			<div className="space-y-2">
				...
				<p className="text-sm font-mono bg-aura-backgroundLight/30 p-1 rounded">
					{color.value}
				</p>
				{color.tailwindClass && (
					<p className="text-sm font-mono bg-aura-backgroundLight/30 p-1 rounded">
			...
			<div className="mb-10">
				...
				<div className="space-y-6">
					<Card className="p-6 bg-futuristic-darkBg">
						<h3 className="text-lg font-medium text-cyan mb-2">
							Cyan text on Dark Background
						</h3>
						<p className="text-cyan">
							This text should have acceptable contrast for accessibility.
						</p>
					</Card>

					<Card className="p-6 bg-futuristic-darkBg">
						<h3 className="text-lg font-medium text-purple mb-2">
					...
					<Card className="p-6 bg-cyan">
						<h3 className="text-lg font-medium text-futuristic-darkBg mb-2">
							Dark Background text on Cyan
						</h3>
						<p className="text-futuristic-darkBg">
							This text should have acceptable contrast for accessibility.
						</p>
					</Card>
					...
					<Card className="p-6 bg-purple">
						<h3 className="text-lg font-medium text-futuristic-darkBg mb-2">
							Dark Background text on Purple
						</h3>
						<p className="text-futuristic-darkBg">
							This text should have acceptable contrast for accessibility.
						</p>
