...
const Resources = () => {
	...
	const affiliateTools = toolsData.filter(
		(tool) => tool.affiliateLinks && tool.affiliateLinks.length > 0,
	);
			...
			<div className="container mx-auto px-4 py-16">
				...
				<div className="text-center mb-16">
					...
					<p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
						Curated tools, courses, and resources that I personally use and
						recommend for building modern web applications. These affiliate
						partnerships help support the development of free content and
						tutorials.
					</p>
						...
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-sm text-muted-foreground">
									This page contains affiliate links. When you click on these
									links and make a purchase, I may earn a commission at no
									additional cost to you. I only recommend tools and services
									that I personally use and believe will add value to your
									development workflow. Your support helps me create more free
