          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-aura-textSecondary">Monitoring your platform's pulse</p>
              </div>
            ...
            <Card className="lg:col-span-2 border-aura-accent/30 bg-gradient-to-br from-aura-darkBg/90 via-aura-darkBgLight/80 to-aura-darkBg/90 backdrop-blur-xl overflow-hidden group hover:shadow-neon-purple transition-all duration-300">
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="hover:bg-aura-neonBlue/20 hover:text-aura-neonBlue transition-colors"
                    >
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className="hover:bg-aura-neonPurple/20 hover:text-aura-neonPurple transition-colors"
                    >
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className="hover:bg-aura-neonPink/20 hover:text-aura-neonPink transition-colors"
                    >
                ...
                <div className="h-64 flex items-end justify-between gap-2">
                  {[
                    45, 62, 55, 78, 65, 85, 72, 92, 88, 95, 90, 98, 94, 96, 93, 97, 95, 99, 96, 100,
                  ].map((height, i) => (
                    <div
                      key={i}
                ...
                <div className="flex items-center justify-between mt-6 pt-4 border-t border-aura-accent/20">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    className="text-aura-neonBlue hover:bg-aura-neonBlue/20"
                  >
                    View Details
