			...
			<div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 relative overflow-hidden">
				...
				<div className="text-center p-8 max-w-md z-10 relative">
					<div className="relative w-40 h-40 mx-auto mb-8">
						...
						{/* Middle glow ring */}
						<div
							className="absolute inset-[10%] rounded-full bg-aura-accent/40 blur-md animate-pulse"
							style={{ animationDelay: "0.2s" }}
						></div>

						{/* Inner content with text */}
						<div className="absolute inset-0 flex items-center justify-center">
							<span className="text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-aura-accent to-blue-400 animate-glow">
								404
							</span>
						</div>
					</div>
