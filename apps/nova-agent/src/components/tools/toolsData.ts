...
export const toolsData: (ToolCardProps & {
...
})[] = [
  {
    ...
    description:
      'Essential development tools and platforms for building modern web applications, with special discounts and affiliate partnerships for maximum value.',
    icon: 'code',
  ...
  },
  {
    ...
    description:
      'Professional design tools for creating stunning user interfaces, prototypes, and visual assets with industry-leading software.',
    icon: 'paintbrush',
    category: 'Design',
  ...
  },
  {
    ...
    description:
      'Advanced marketing automation and analytics platforms to grow your business with data-driven insights and automated campaigns.',
    icon: 'chartBar',
    category: 'Marketing',
  ...
  },
  {
    ...
    description:
      'Top-rated online courses and learning platforms to master new technologies, programming languages, and business skills.',
    icon: 'book',
    category: 'Education',
  ...
  },
  {
    ...
    description:
      'Business tools and productivity software to streamline workflows, manage projects, and scale your development business.',
    icon: 'briefcase',
    category: 'Business',
  ...
  },
  {
    title: 'Hardware & Gear',
    description:
      'Recommended development hardware, monitors, keyboards, and tech gear for optimal coding performance and workspace setup.',
    icon: 'monitor',
    category: 'Hardware',
