    ...
    <FuturisticCard className="h-full" variant={variant}>
      <div className="flex flex-col h-full">
        <div className="mb-6 flex items-start justify-between">
          <div className="p-3 rounded-lg bg-aura-backgroundLight/50">{icon}</div>
          <span className="text-xs uppercase tracking-wider text-aura-accent/70">{category}</span>
        </div>

        <h3 className="text-xl font-semibold mb-3 font-heading text-white">{title}</h3>
