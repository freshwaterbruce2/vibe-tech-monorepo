...
const getDefaultProjectPath = () => {
  const root = import.meta.env.VITE_PROJECT_ROOT ?? 'V:\\monorepo';
  return `${root}\\apps`;
};
...
export function ProjectCreator() {
  ...
  const [path, setPath] = useState(getDefaultProjectPath);
  ...
  return (
    <div className="border border-purple-500/30 bg-black/40 rounded-lg p-4">
      ...
      <div className="space-y-3">
        <div>
          <label className="block text-sm font-medium mb-1 text-gray-300">Template</label>
          <select
