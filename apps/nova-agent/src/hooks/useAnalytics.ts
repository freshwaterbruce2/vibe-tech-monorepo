...
/** Build general-purpose tracking helpers bound to a trackEvent function */
function buildGeneralTrackers(trackEvent: TrackEvent) {
  ...
  return { trackServiceView, trackButtonClick, trackFeatureInteraction };
}

/** Build dashboard-specific tracking helpers bound to a trackEvent function */
function buildDashboardTrackers(trackEvent: TrackEvent) {
...
export const useAnalytics = () => {
  ...
  return {
    trackEvent,
    ...buildGeneralTrackers(trackEvent),
    ...buildDashboardTrackers(trackEvent),
  };
};
