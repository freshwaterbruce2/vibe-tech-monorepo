...
function createInitialNovaData(): NovaData {
  return {
    tasks: [],
    activities: [],
    learningEvents: [],
...
export function useNovaData(autoRefresh: boolean = true, refreshInterval: number = 30000) {
  const [data, setData] = useState<NovaData>(createInitialNovaData);
