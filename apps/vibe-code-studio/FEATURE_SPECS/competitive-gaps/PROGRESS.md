...
- Open follow-ups: OS desktop notifications (Tauri notification plugin not installed — needs Bruce's dependency sign-off) · chat slash-command variant · inline schedule editing.
