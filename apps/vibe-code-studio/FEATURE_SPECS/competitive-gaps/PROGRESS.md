...
| 07  | LSP language intelligence            | 🟡 1a+1b+1c done | `aee44d95`, `04d4344c`, `9f7f3d23` | Diagnostics + hover/def/outline + completion/find-refs + cross-file def jump. Deferred: rename, cross-file refs peek preview, markers, phase 2 (auto-download/multi-root/Settings) |
