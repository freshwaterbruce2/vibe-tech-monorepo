...
| 07  | LSP language intelligence            | 🔄 1c in progress | `aee44d95`, `04d4344c` | 1a+1b done. 1c (completion + find-references + cross-file def jump wiring) IN PROGRESS 2026-07-04. rename + markers + phase 2 deferred |
