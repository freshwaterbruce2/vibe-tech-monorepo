...
| 07  | LSP language intelligence            | 🟡 Phase 1a done | `aee44d95`             | Diagnostics: hand-rolled client + 5004-backend relay → problemsStore. 1b (hover/def/markers)/1c (completion/refs) + phase 2 deferred |
