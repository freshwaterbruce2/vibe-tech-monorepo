...
| 09  | Verifiable Artifacts                 | 🟡 Phases 1–2 done | `91d3ba21`, `fe774ff5`, `4827c6e9`             | P2 shipped 2026-07-05: injection primitive in `BackgroundAgentSystem` (SHARED — see below) + comment threads on task_list/plan artifacts. P3 (walkthrough) deferred                                                                                                              |
