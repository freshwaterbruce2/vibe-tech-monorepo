...
import type { CodeContext } from '../../services/ContextService';
import { ContextService } from '../../services/ContextService';
import type { EditorFile, WorkspaceContext } from '../../types';
  ...
  describe('getContextWindow', () => {
    ...
    it.skip('should respect token limits', () => {
      ...
      const context: CodeContext = {
        ...
        recentFiles: [],
        relatedFiles: [
          { path: '/test/helper.ts', content: largeContent, relevance: 0.9, reason: 'imports' }
        ]
      };
