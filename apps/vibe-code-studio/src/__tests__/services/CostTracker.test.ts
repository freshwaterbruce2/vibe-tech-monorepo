...
describe('CostTracker', () => {
  ...
  describe('Usage Tracking', () => {
    it('should track single request', () => {
      ...
      tracker.trackUsage('openai/gpt-5.2-codex', 1000, 500);
    ...
    it('should track multiple requests', () => {
      ...
      tracker.trackUsage('openai/gpt-5.2-codex', 1000, 500);
      tracker.trackUsage('deepseek/deepseek-v3.2', 2000, 1000);
    ...
    it('should track per-model usage', () => {
      ...
      tracker.trackUsage('openai/gpt-5.2-codex', 1000, 500);
      tracker.trackUsage('openai/gpt-5.2-codex', 2000, 1000);

      const modelUsage = tracker.getModelUsage('openai/gpt-5.2-codex');
  ...
  describe('Cost Calculation', () => {
    ...
    it('should calculate per-model cost', () => {
      ...
      tracker.trackUsage('openai/gpt-5.2-codex', 1000, 500);
      const cost = tracker.getModelCost('openai/gpt-5.2-codex');
  ...
  describe('Budget Management', () => {
    ...
    it('should check if over budget', () => {
      ...
      tracker.trackUsage('openai/gpt-5.2-codex', 10000, 5000);
  ...
  describe('Analytics', () => {
    ...
    it('should get most used model', () => {
      ...
      tracker.trackUsage('openai/gpt-5.2-codex', 1000, 500);
      tracker.trackUsage('openai/gpt-5.2-codex', 1000, 500);
      tracker.trackUsage('deepseek/deepseek-v3.2', 1000, 500);

      const mostUsed = tracker.getMostUsedModel();

      expect(mostUsed).toBe('openai/gpt-5.2-codex');
    });
    ...
    it('should get most expensive model', () => {
      ...
      tracker.trackUsage('openai/gpt-5.2-codex', 10000, 5000);
      tracker.trackUsage('deepseek/deepseek-v3.2', 10000, 5000);

      const mostExpensive = tracker.getMostExpensiveModel();

      expect(mostExpensive).toBe('openai/gpt-5.2-codex');
    });
  ...
  describe('Data Persistence', () => {
    ...
    it('should import data', () => {
      ...
      const data = {
        entries: [
          { modelId: 'openai/gpt-5.2-codex', inputTokens: 1000, outputTokens: 500, timestamp: new Date(), cost: 0.045 }
        ]
      };
