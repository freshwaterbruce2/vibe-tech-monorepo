...
describe('ModelRegistry', () => {
  ...
  describe('Model Information', () => {
    it('should get model by id', () => {
      ...
      const registry = new ModelRegistry();
      const model = registry.getModel('openai/gpt-5.2-codex');

      expect(model).toBeDefined();
      expect(model.id).toBe('openai/gpt-5.2-codex');
    });
  ...
  describe('Model Pricing', () => {
    ...
    it('should calculate request cost', () => {
      ...
      const registry = new ModelRegistry();
      const cost = registry.calculateCost('openai/gpt-5.2-codex', 1000, 500);
    ...
    it('should compare model costs', () => {
      ...
      const registry = new ModelRegistry();
      const comparison = registry.compareCosts(['openai/gpt-5.2-codex', 'deepseek/deepseek-v3.2'], 1000, 500);
  ...
  describe('Model Capabilities', () => {
    ...
    it('should check if model supports capability', () => {
      ...
      const registry = new ModelRegistry();
      const supports = registry.supportsCapability('openai/gpt-5.2-codex', 'code-generation');
  ...
  describe('Model Registration', () => {
    ...
    it('should update existing model', () => {
      ...
      const registry = new ModelRegistry();
      registry.updateModel('openai/gpt-5.2-codex', { pricing: { inputCostPer1k: 0.05 } });
    ...
    it('should remove model', () => {
      ...
      const registry = new ModelRegistry();
      registry.removeModel('openai/gpt-5.2-codex');
