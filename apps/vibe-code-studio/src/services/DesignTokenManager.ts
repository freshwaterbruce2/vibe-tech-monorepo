...
export class DesignTokenManager {
  ...
  async saveToLocalStorage(key: string = 'design-tokens'): Promise<void> {
  ...
  static async load(key: string = 'design-tokens'): Promise<DesignTokenManager> {
    if (typeof window !== 'undefined') {
