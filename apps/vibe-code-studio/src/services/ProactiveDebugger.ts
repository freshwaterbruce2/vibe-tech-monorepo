...
export class ProactiveDebugger {
   ...
   */
  async predictErrors(code: string, _file: string): Promise<PredictedError[]> {
...
Provide insights as a JSON array of strings.`;
   ...
   */
  private detectTypeMismatches(_code: string): PredictedError[] {
   ...
   */
  private async aiPredictErrors(_code: string): Promise<PredictedError[]> {
