...
Provide performance analysis and optimization recommendations.`;
  ...
  private async performPerformanceAnalysis(_context: AgentContext): Promise<PerformanceAnalysis> {
  ...
  private async identifyOptimizations(_context: AgentContext): Promise<OptimizationSuggestion[]> {
