...
const buildCategories = (shortcuts: KeyboardShortcut[]): ShortcutCategory[] => {
...
const groupShortcuts = (shortcuts: KeyboardShortcut[]): ShortcutCategory[] => {
...
export const KeyboardShortcuts = ({
  ...
  const categories = buildCategories(shortcuts);
  const filteredShortcuts = filterShortcuts(shortcuts, searchQuery, selectedCategory);
  const groupedShortcuts = groupShortcuts(filteredShortcuts);
