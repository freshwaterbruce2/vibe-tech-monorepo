...
import { Check, Copy, Download, Eye, Filter, Package, Search, Star } from 'lucide-react';
import {
  CategorySection,
  CategoryTitle,
  CodeBlock,
...
import type { ComponentLibraryProps, UIComponent } from './types';
import { useComponentLibrary } from './useComponentLibrary';

export const ComponentLibrary = ({ onInsertComponent }: ComponentLibraryProps) => {
  const {
    searchQuery,
    setSearchQuery,
    selectedComponent,
    ...
    >
      ...
      <Content>
        {Object.entries(groupedComponents).map(
          ([category, components]: [string, UIComponent[]]) => (
                ...
                {components.map(component => (
                  ...
                  >
                    ...
                    <ComponentActions>
                      ...
                      <IconButton onClick={async () => handleCopy(component)}>
