    ...
    <SearchContainer $isOpen={isOpen}>
      <SearchHeader>
        ...
        <OptionsRow>
          ...
          <OptionButton $active={options.wholeWord} onClick={() => toggleOption('wholeWord')}>
            Ab
          </OptionButton>
          <OptionButton $active={options.regex} onClick={() => toggleOption('regex')}>
            .*
          </OptionButton>
        </OptionsRow>
        ...
        <OptionsRow>
          ...
          <OptionButton
            ...
            title={
              workspaceRoot
                ? 'Search all files in the workspace recursively'
