// React 19 - only import what we need
import React, { Fragment } from 'react';
import styled from 'styled-components';

import { vibeTheme } from '../styles/theme';
import type { MessagePart} from '../utils/messageFormatter';
import {parseMessageSafely, validateMessageContent } from '../utils/messageFormatter';
...
const SecureMessageContent = ({ content, role }: SecureMessageContentProps) => {
