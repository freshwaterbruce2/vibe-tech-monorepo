...
export const SortableItemStyled = styled.div<{ $isDragging: boolean; $isSelected?: boolean }>`
  padding: 16px;
  border-radius: 8px;
  border: 2px solid ${props => props.$isDragging || props.$isSelected ? vibeTheme.colors.cyan : vibeTheme.colors.border};
