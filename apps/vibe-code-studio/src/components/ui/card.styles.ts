/**
 * Card styled parts and style tokens.
 * Kept out of card.tsx so Fast Refresh works (react-refresh/only-export-components).
 */
...
const variantStyles = {
  ...
  glass: css`
    background: linear-gradient(135deg, rgba(139, 92, 246, 0.05) 0%, rgba(0, 212, 255, 0.03) 100%);
    border: 1px solid rgba(139, 92, 246, 0.2);
...
export const StyledCard = styled(motion.div).withConfig({
