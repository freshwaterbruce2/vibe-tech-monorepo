...
const strategies = [
  {
    ...
    label: 'Fast',
    icon: Zap,
    description: 'Primary model — best for rapid prototyping',
  ...
  },
  {
    ...
    details: 'Primary model for simple code, upgrades for complex patterns',
    badge: 'Recommended',
    color: 'text-blue-600',
  },
  {
    ...
    details: 'Uses Claude Sonnet if API key provided, else primary model',
    badge: 'Premium',
...
export const ModelStrategyPanel = ({
  currentStrategy,
  onStrategyChange,
        ...
        <CardDescription>
          ...
          {!hasAnthropicKey && (
            <span className="block mt-2 text-yellow-600 dark:text-yellow-500">
              Add an Anthropic API key to unlock Claude models.
            </span>
          )}
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
          ...
          <div className="space-y-1 text-xs text-gray-600 dark:text-gray-400">
            <div>
              <span className="font-medium">Primary AI: </span>Kimi 2.5 Pro
            </div>
            {hasAnthropicKey && (
              <>
                <div>
                  <span className="font-medium">Optional Models: </span>Claude Haiku 4.5, Claude Sonnet 4.6
                </div>
                <div>
