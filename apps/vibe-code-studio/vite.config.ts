...
export default defineConfig(({ mode }) => ({
  ...
  resolve: {
    alias: {
      ...
      'fs/promises': resolve(__dirname, 'src/shims/fs-shim.js'),
      'node:fs/promises': resolve(__dirname, 'src/shims/fs-shim.js'),
      'fs': resolve(__dirname, 'src/shims/fs-shim.js'),
      'node:fs': resolve(__dirname, 'src/shims/fs-shim.js'),
      ...
      'node:http': resolve(__dirname, 'src/shims/empty-module.js'),
      'https': resolve(__dirname, 'src/shims/empty-module.js'),
      'node:https': resolve(__dirname, 'src/shims/empty-module.js'),
      'stream': resolve(__dirname, 'src/shims/empty-module.js'),
      'node:stream': resolve(__dirname, 'src/shims/empty-module.js'),
      'zlib': resolve(__dirname, 'src/shims/empty-module.js'),
      'node:zlib': resolve(__dirname, 'src/shims/empty-module.js'),
      'net': resolve(__dirname, 'src/shims/empty-module.js'),
      'node:net': resolve(__dirname, 'src/shims/empty-module.js'),
      'tls': resolve(__dirname, 'src/shims/empty-module.js'),
      'node:tls': resolve(__dirname, 'src/shims/empty-module.js'),
      'child_process': resolve(__dirname, 'src/shims/empty-module.js'),
      'node:child_process': resolve(__dirname, 'src/shims/empty-module.js'),
      'url': resolve(__dirname, 'src/shims/empty-module.js'),
      'node:url': resolve(__dirname, 'src/shims/empty-module.js'),
    },
  },
