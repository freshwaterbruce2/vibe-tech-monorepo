...
const appPort = 6090 + 2;
const appHost = '127.0.0.1';
const appBaseUrl = 'http://127.0.0.1:5090';
const authSecret = 'business-booking-v2-local-auth-secret-12345';
const operatorEmail = 'owner@example.com';
const operatorPassword = 'change-this-password';
const operatorName = 'BusinessBookingV2 Owner';
