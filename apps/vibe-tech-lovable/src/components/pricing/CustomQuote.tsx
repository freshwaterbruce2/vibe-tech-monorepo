  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl md:text-3xl font-bold mb-6 bg-gradient-to-r from-[#c87eff] via-[#8d4dff] to-[#00f7ff] text-transparent bg-clip-text">
        Need a custom launch lane?
      </h2>
      <p className="mb-8 text-white max-w-xl mx-auto">
        Use a custom lane for products that need deeper positioning, checkout messaging,
        deployment coordination, or a dedicated buyer workflow before going public.
      </p>
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        ...
        >
          <span className="relative z-10">Plan Custom Launch</span>
        </Button>
        <Button
          variant="outline"
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto text-sm">
        <div className="flex flex-col items-center">
          <div className="text-aura-accent text-xl font-bold mb-1">3+</div>
          <div className="text-white">Products to Promote</div>
        </div>
        <div className="flex flex-col items-center">
          <div className="text-aura-accent text-xl font-bold mb-1">1</div>
          <div className="text-white">Central Website</div>
        </div>
        <div className="flex flex-col items-center">
          <div className="text-aura-accent text-xl font-bold mb-1">Live</div>
          <div className="text-white">Launch Path</div>
        </div>
      </div>
    </motion.div>
  );
