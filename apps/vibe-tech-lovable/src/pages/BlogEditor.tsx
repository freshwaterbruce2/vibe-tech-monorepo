...
const BlogEditor = () => {
  ...
  const updateAffiliatePlacement = (
  ...
  const applyTemplate = (templateId: string) => {
    ...
    switch (templateId) {
      case 'programming':
        templateData = createProgrammingTutorialTemplate(post.title || 'New Programming Tutorial', [
          'React',
          'TypeScript',
        ]);
        break;
      case 'tool-review':
        templateData = createToolReviewTemplate('Tool Name', 'Development');
        break;
      case 'business':
        templateData = createBusinessGuideTemplate('Business Topic', 'Career Development');
        break;
    }
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Create and manage blog posts with integrated affiliate marketing
              </p>
            </div>
                    ...
                    <Tabs defaultValue="content" className="w-full">
                      ...
                      <TabsContent value="content" className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            Supports markdown: **bold**, *italic*, `code`, ### headings, ```code
                            blocks```
                          </p>
                        </div>
                      </TabsContent>
                      ...
                      <TabsContent value="seo" className="space-y-4">
                        ...
                        <div>
                          ...
                          >
                            {post.seoDescription?.length || 0}/160 characters{' '}
                            {(post.seoDescription?.length || 0) > 160 && '(too long)'}
                          </p>
                        </div>
                            ...
                            {affiliateLibrary.map((affiliate, index) => (
                              ...
                              >
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  disabled={selectedAffiliates.some(
                                    (a) => a.name === affiliate.name,
                                  )}
                                >
                    ...
                    <Card className="p-4">
                      ...
                      <div className="space-y-3">
                        {selectedAffiliates.slice(0, 2).map((affiliate, index) => (
                          <AffiliateBox key={index} recommendation={affiliate} variant="sidebar" />
                        ))}
                      </div>
                    </Card>
                  )}
                  ...
                  {selectedAffiliates.length > 0 && (
                    <div className="mt-8">
                      ...
                      <div className="grid gap-4">
                        {selectedAffiliates.map((affiliate, index) => (
                          <AffiliateBox key={index} recommendation={affiliate} variant="footer" />
                        ))}
                      </div>
                    </div>
                  )}
