...
2. ⬜ Migrate test files (remove event_loop, add @pytest.mark.asyncio)
3. ⬜ Run test suite: `pytest tests/ -v`
4. ⬜ Test WebSocket connection stability (24 hours)
5. ⬜ Test REST API integration

### Production

11. ⬜ Dry run trading for 24-48 hours
2. ⬜ Monitor logs for anomalies
3. ⬜ Resume live trading if stable
