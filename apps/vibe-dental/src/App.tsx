  ...
  if (pathname === '/terms') {
    return (
      <LegalPage
        ...
        intro="This SaaS app includes terms of service for Vibe-Tech (vibe-tech.org) dental clinic scheduler."
        sections={[
          {
          ...
          },
          {
            ...
            body: 'Do not upload or submit unauthorized content to the Vibe-Tech dental clinic scheduler.',
          },
        ]}
      />
    );
  ...
  if (pathname === '/privacy') {
    return (
      <LegalPage
        ...
        intro="This SaaS app includes privacy policy for Vibe-Tech (vibe-tech.org) dental clinic scheduler."
        sections={[
          {
          ...
          {
            heading: 'Analytics',
            body: 'Analytics help Vibe-Tech optimize dental clinic scheduler user experiences.',
          },
        ]}
      />
    );
