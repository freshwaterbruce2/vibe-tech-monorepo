...
const authSecret = 'dental-scheduler-local-auth-secret-12345';
...
const testAuthDbPath = 'D:\\databases\\vibe-dental-test-auth.db';
...
async function runLocalApiSmoke(): Promise<void> {
  ...
  const env = {
    ...
    APP_DB_PATH: 'D:\\databases\\vibe-dental-test.db',
  ...
  try {
    ...
    results.push({
      ...
      ok: proRoute.feature === 'scheduling.automated_slots',
      detail:
        proRoute.feature === 'scheduling.automated_slots'
