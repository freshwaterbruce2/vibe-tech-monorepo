...
const appPort = 5360 + 2;
const appHost = '127.0.0.1';
const appBaseUrl = 'http://127.0.0.1:4360';
const authSecret = 'cme-track-local-auth-secret-12345';
...
const testAuthDbPath = 'D:\\databases\\cme-track-test-auth.db';
