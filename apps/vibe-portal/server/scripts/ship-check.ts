...
const appPort = 5330 + 2;
const appHost = '127.0.0.1';
const appBaseUrl = 'http://127.0.0.1:4330';
const authSecret = 'client-portal-local-auth-secret-12345';
...
async function runLocalApiSmoke(): Promise<void> {
  ...
  try {
    ...
    results.push({
      ...
      ok: proRoute.feature === 'project.management',
      detail:
        proRoute.feature === 'project.management'
