# FactoryRuntimeSmoke Deployment
...
```powershell
pnpm nx run _-factory-runtime-smoke:ship:check
```
...
PORT=5320
HOST=0.0.0.0
APP_BASE_URL=https://_-factory-runtime-smoke.your-domain.com
AUTH_SECRET=
DEMO_USER_EMAIL=
DEMO_USER_PASSWORD=
DEMO_USER_NAME=
...
```env
VITE_API_BASE_URL=https://_-factory-runtime-smoke-api.your-domain.com
VITE_POSTHOG_KEY=
VITE_POSTHOG_HOST=
...
4. Confirm `GET /api/health` returns `{"ok":true,"app":"_-factory-runtime-smoke"}`.
...
2. Set the project root to `apps/_-factory-runtime-smoke`.
