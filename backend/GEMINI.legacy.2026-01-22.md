...
- **`nova-sqlite-mcp`**: MCP server providing safe access to SQLite databases.
- **`openrouter-proxy`**: Proxy service for AI model inference requests (OpenRouter/DeepSeek).
