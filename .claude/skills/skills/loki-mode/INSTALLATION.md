...
git clone https://codeberg.org/asklokesh/loki-mode.git ~/.claude/skills/loki-mode
```
...
VERSION=$(curl -s https://codeberg.org/api/v1/repos/asklokesh/loki-mode/releases/latest | grep tag_name | cut -d'"' -f4 | tr -d 'v')

# Download and extract
curl -L -o loki-mode.zip "https://codeberg.org/asklokesh/loki-mode/releases/download/v${VERSION}/loki-mode-claude-code-${VERSION}.zip"
...
curl -o ~/.claude/skills/loki-mode/SKILL.md \
  https://codeberg.org/asklokesh/loki-mode/raw/branch/main/SKILL.md

# Download agent definitions
curl -o ~/.claude/skills/loki-mode/references/agents.md \
  https://codeberg.org/asklokesh/loki-mode/raw/branch/main/references/agents.md

# Download deployment guides
curl -o ~/.claude/skills/loki-mode/references/deployment.md \
  https://codeberg.org/asklokesh/loki-mode/raw/branch/main/references/deployment.md

# Download business operations reference
curl -o ~/.claude/skills/loki-mode/references/business-ops.md \
  https://codeberg.org/asklokesh/loki-mode/raw/branch/main/references/business-ops.md
```
...
1. Go to [Releases](https://codeberg.org/asklokesh/loki-mode/releases)
2. Download **either**:
...
4. **Join the Community:** Report issues or contribute at [Codeberg](https://codeberg.org/asklokesh/loki-mode)

---

## Need Help?

- **Issues/Bugs:** [Codeberg Issues](https://codeberg.org/asklokesh/loki-mode/issues)
- **Discussions:** [Use Issue Threads](https://codeberg.org/asklokesh/loki-mode/issues)
