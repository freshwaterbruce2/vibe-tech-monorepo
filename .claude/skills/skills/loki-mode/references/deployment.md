...
pipeline:
  deploy:
    ...
    commands:
      ...
      - docker build -t 123456789012.dkr.ecr.us-east-1.amazonaws.com/app:${CI_COMMIT_SHA} .
      - docker push 123456789012.dkr.ecr.us-east-1.amazonaws.com/app:${CI_COMMIT_SHA}
      - >
