...
- **Codeberg**: [asklokesh/loki-mode](https://codeberg.org/asklokesh/loki-mode)
- **License**: MIT
- **Version**: 2.25.0
...
git clone https://codeberg.org/asklokesh/loki-mode.git
...
- Codeberg: [@asklokesh](https://codeberg.org/asklokesh)
