...
**Expected Behavior:**
- ✅ MUST call Glob pattern="**/*db*.ts" or "**/*database*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*api*.ts" AND pattern="**/*user*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*util*.ts" OR "**/*helper*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*types*.ts" OR "**/*user*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*API*.md" OR "**/*api-docs*.md"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/Button*.tsx"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*modal*.tsx" OR "**/*dialog*.tsx"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/Login*.tsx" OR "**/*form*.tsx"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/Icon*.tsx"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/Error*.tsx"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*api*.ts" OR "**/*service*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*db*.ts" OR "**/*database*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*event*.ts" OR "**/*handler*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/middleware*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*websocket*.ts" OR "**/*ws*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*queue*.ts" OR "**/*job*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*email*.ts" OR "**/*mail*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*payment*.ts" OR "**/*stripe*.ts"
...
**Expected Behavior:**
- ✅ MUST search: Glob pattern="**/*storage*.ts" OR "**/*s3*.ts"
