...
export default {
	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				"radial-tech":
					'radial-gradient(at 50% 75%,var(--bg-start) 0%,var(--bg-mid) 45%,var(--bg-end) 100%),url("/assets/circuit.svg")',
				"hero-gradient":
					'radial-gradient(at 50% 75%, #080810 0%, #0D0D1A 50%, #111125 100%), url("/assets/circuit.svg")',
			},
			borderRadius: {
				lg: "var(--radius)",
			...
			keyframes: {
				...
				glow: {
					"0%": {
						opacity: "1",
						textShadow:
							"0 0 20px rgba(0, 255, 255, 0.8), 0 0 30px rgba(0, 255, 255, 0.6), 0 0 40px rgba(0, 255, 255, 0.4)",
					},
					"50%": {
						opacity: "0.8",
						textShadow:
				...
				"pulse-glow": {
					...
					"50%": {
						opacity: "0.7",
						boxShadow:
							"0 0 10px rgba(0, 255, 255, 0.5), 0 0 15px rgba(0, 255, 255, 0.3)",
					},
				},
				"flicker-border": {
			...
			boxShadow: {
				...
				"neon-lg":
					"0 0 10px rgba(0, 255, 255, 0.5), 0 0 30px rgba(0, 255, 255, 0.3), 0 0 50px rgba(0, 255, 255, 0.1)",
				"neon-blue":
					"0 0 10px rgba(0, 255, 255, 0.7), 0 0 20px rgba(0, 255, 255, 0.4)",
				"neon-purple":
					"0 0 10px rgba(185, 51, 255, 0.7), 0 0 20px rgba(185, 51, 255, 0.4)",
				"neon-pink":
					"0 0 10px rgba(255, 0, 170, 0.7), 0 0 20px rgba(255, 0, 170, 0.4)",
				"neon-teal":
					"0 0 10px rgba(0, 255, 204, 0.7), 0 0 20px rgba(0, 255, 204, 0.4)",
