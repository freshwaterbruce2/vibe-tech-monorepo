...
const targetDirs = [
  'C:\\dev\\.claude\\worktrees\\agent-a67c7b8b71e7d9169',
  'C:\\dev\\.claude\\worktrees\\fix-sync-audit-pr24',
  'C:\\dev\\.claude\\worktrees\\happy-rosalind-3187ef',
  'C:\\dev\\_worktrees\\fap',
  'C:\\dev-main-ci-fix',
  'C:\\tmp\\pr16-resolve',
  'C:\\tmp\\pr8-resolve',
  'C:\\tmp\\proposal-sync-audit',
  'C:\\vibetech-workstreams\\monetization-engine',
  'C:\\vibetech-workstreams\\monetization-integration',
  'D:\\nova-worktrees'
];
  ...
  try {
    ...
    list.forEach((file) => {
      ...
      if (stat && stat.isDirectory()) {
        ...
        if (bn !== 'node_modules' && bn !== 'dist' && bn !== '.git' && bn !== '.nx' && bn !== 'coverage') {
          results = results.concat(getFiles(filePath));
        }
      } else if (file.endsWith('.ts') || file.endsWith('.js') || file.endsWith('.cjs') || file.endsWith('.mjs')) {
...
console.log('Worktree scan complete.');
