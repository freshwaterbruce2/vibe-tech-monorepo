...
const CRYPTO_ENHANCED_TRADING_ENTRY: DatabaseInventoryEntry = {
...
export const FALLBACK_DATABASE_INVENTORY: readonly DatabaseInventoryEntry[] = [
  {
    name: 'memory.db',
...
function buildPurpose(owner: string, domain: string): string {
...
function dedupeByPath(entries: readonly DatabaseInventoryEntry[]): DatabaseInventoryEntry[] {
  const seen = new Set<string>();
  const deduped: DatabaseInventoryEntry[] = [];
