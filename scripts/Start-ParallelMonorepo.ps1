...
try {
    ...
    Write-OrchestratorLog "Console control handling unavailable in this host: $($_.Exception.Message)" "DEBUG"
}

try {
    Register-EngineEvent -SourceIdentifier "ControlC" -Action {
    ...
    Write-OrchestratorLog "ControlC event registration unavailable: $($_.Exception.Message)" "DEBUG"
}
...
try {
    ...
    try {
        ...
        # Non-interactive host; nothing to reset.
    }
}
